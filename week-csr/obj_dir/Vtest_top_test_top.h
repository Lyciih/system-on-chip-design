...
VL_MODULE(Vtest_top_test_top) {
  public:
    ...
    QData/*63:0*/ __Vcellout__timer0__second_count;
    QData/*63:0*/ u_bus__DOT____Vlvbound4;
    QData/*63:0*/ u_bus__DOT____Vlvbound10;
    IData/*31:0*/ __Vcellinp__u_bus__cfg_device_addr_mask[3];
    IData/*31:0*/ __Vcellinp__u_bus__cfg_device_addr_base[3];
    QData/*63:0*/ __Vcellinp__u_bus__device_rdata_i[3];
    QData/*63:0*/ __Vcellout__u_bus__device_wdata_o[3];
    ...
    QData/*63:0*/ __Vcellout__u_bus__host_rdata_o[1];
    QData/*63:0*/ __Vcellinp__u_bus__host_wdata_i[1];
