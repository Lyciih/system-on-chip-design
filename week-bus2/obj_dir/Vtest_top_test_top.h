...
VL_MODULE(Vtest_top_test_top) {
  public:
    ...
    CData/*0:0*/ __PVT__device_req[2];
    IData/*31:0*/ __PVT__device_addr[2];
    CData/*0:0*/ __PVT__device_we[2];
    IData/*31:0*/ __PVT__device_wdata[2];
    IData/*31:0*/ __PVT__device_rdata[2];
    IData/*31:0*/ __PVT__cfg_device_addr_base[2];
    IData/*31:0*/ __PVT__cfg_device_addr_mask[2];
    
    // LOCAL VARIABLES
    CData/*0:0*/ u_bus__DOT____Vlvbound4;
    IData/*31:0*/ u_bus__DOT____Vlvbound2;
    IData/*31:0*/ __Vcellinp__u_bus__cfg_device_addr_mask[2];
    IData/*31:0*/ __Vcellinp__u_bus__cfg_device_addr_base[2];
    IData/*31:0*/ __Vcellinp__u_bus__device_rdata_i[2];
    IData/*31:0*/ __Vcellout__u_bus__device_wdata_o[2];
    CData/*0:0*/ __Vcellout__u_bus__device_we_o[2];
    IData/*31:0*/ __Vcellout__u_bus__device_addr_o[2];
    CData/*0:0*/ __Vcellout__u_bus__device_req_o[2];
