...
VL_INLINE_OPT void Vtest_top_test_top::_combo__TOP__test_top__4(Vtest_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vtest_top_test_top::_combo__TOP__test_top__4\n"); );
    Vtest_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlSymsp->TOP__test_top.__PVT__exe_reg_waddr_o = 
    ...
    if (vlTOPp->rst_i) {
        ...
        vlSymsp->TOP__test_top.__PVT__exe0__DOT__shift_result = 0U;
    } else {
        vlSymsp->TOP__test_top.__PVT__mem_reg_waddr_o 
            = vlSymsp->TOP__test_top.__PVT__exe_mem_reg_waddr_o;
        vlSymsp->TOP__test_top.__PVT__mem_reg_wdata_o 
        ...
        vlSymsp->TOP__test_top.__PVT__exe0__DOT__shift_result 
            = ((0x4000U & vlSymsp->TOP__test_top.__PVT__id_exe_inst_o)
               ...
               [(0x1fU & (vlSymsp->TOP__test_top.__PVT__id_exe_inst_o 
                          >> 0x14U))] : vlSymsp->TOP__test_top.__PVT__exe0__DOT__shift0__DOT__shift_l_temp
               [(0x1fU & (vlSymsp->TOP__test_top.__PVT__id_exe_inst_o 
                          >> 0x14U))]);
    }
    if (vlTOPp->rst_i) {
