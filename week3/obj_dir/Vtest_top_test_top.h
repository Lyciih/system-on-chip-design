...
VL_MODULE(Vtest_top_test_top) {
  public:
    ...
    IData/*31:0*/ __PVT__exe0__DOT__shift_result;
    IData/*31:0*/ __PVT__exe0__DOT__compare_sub;
    IData/*31:0*/ __PVT__exe0__DOT__shift0__DOT__shift_l_temp[32];
    IData/*31:0*/ __PVT__exe0__DOT__shift0__DOT__shift_r_temp[32];
  ...
  public:
    ...
    static void _combo__TOP__test_top__4(Vtest_top__Syms* __restrict vlSymsp);
  private:
