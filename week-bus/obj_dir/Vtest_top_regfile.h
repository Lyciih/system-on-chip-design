...
VL_MODULE(Vtest_top_regfile) {
  ...
  public:
    ...
    static void _sequent__TOP__test_top__core_top0__regfile0__2(Vtest_top__Syms* __restrict vlSymsp);
    static void _settle__TOP__test_top__core_top0__regfile0__3(Vtest_top__Syms* __restrict vlSymsp);
