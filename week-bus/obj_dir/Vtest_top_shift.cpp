...
VL_INLINE_OPT void Vtest_top_shift::_settle__TOP__test_top__core_top0__exe0__DOT__shift_i_type__1(Vtest_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_top_shift::_settle__TOP__test_top__core_top0__exe0__DOT__shift_i_type__1\n"); );
    ...
    if (vlTOPp->rst_i) {
        ...
        this->__PVT__shift_l_temp[0U] = vlSymsp->TOP__test_top__core_top0.__PVT__id_exe_op1_o;
        this->__PVT__shift_r_temp[0U] = vlSymsp->TOP__test_top__core_top0.__PVT__id_exe_op1_o;
