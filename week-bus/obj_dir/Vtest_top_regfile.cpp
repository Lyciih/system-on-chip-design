...
VL_INLINE_OPT void Vtest_top_regfile::_sequent__TOP__test_top__core_top0__regfile0__2(Vtest_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtest_top_regfile::_sequent__TOP__test_top__core_top0__regfile0__2\n"); );
    Vtest_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
...
VL_INLINE_OPT void Vtest_top_regfile::_settle__TOP__test_top__core_top0__regfile0__3(Vtest_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtest_top_regfile::_settle__TOP__test_top__core_top0__regfile0__3\n"); );
    Vtest_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
