...
void Vtest_top_core_top::_settle__TOP__test_top__core_top0__3(Vtest_top__Syms* __restrict vlSymsp) {
...
void Vtest_top_core_top::_ctor_var_reset() {
    ...
    __PVT__halt_o = VL_RAND_RESET_I(1);
    __PVT__ram_we_o = VL_RAND_RESET_I(1);
    __PVT__ram_addr_o = VL_RAND_RESET_I(32);
    __PVT__ram_data_o = VL_RAND_RESET_I(32);
    __PVT__ram_data_i = VL_RAND_RESET_I(32);
