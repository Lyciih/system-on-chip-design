...
VL_INLINE_OPT void Vtest_top_core_top::_sequent__TOP__test_top__core_top0__1(Vtest_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtest_top_core_top::_sequent__TOP__test_top__core_top0__1\n"); );
...
VL_INLINE_OPT void Vtest_top_core_top::_sequent__TOP__test_top__core_top0__2(Vtest_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtest_top_core_top::_sequent__TOP__test_top__core_top0__2\n"); );
    Vtest_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vtest_top_core_top::_settle__TOP__test_top__core_top0__4(Vtest_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtest_top_core_top::_settle__TOP__test_top__core_top0__4\n"); );
    Vtest_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    if (vlTOPp->rst_i) {
    ...
    if (vlTOPp->rst_i) {
        vlSymsp->TOP__test_top__core_top0.__PVT__ram_data_o = 0U;
    } else {
        if ((8U & (IData)(vlSymsp->TOP__test_top__core_top0.__PVT__exe_mem_mem_op_o))) {
            ...
            vlSymsp->TOP__test_top__core_top0.__PVT__ram_data_o 
                    ...
                    ? 0U : ((2U & (IData)(vlSymsp->TOP__test_top__core_top0.__PVT__exe_mem_mem_op_o))
                             ...
                             : ((1U & (IData)(vlSymsp->TOP__test_top__core_top0.__PVT__exe_mem_mem_op_o))
                                 ? ((0U == (3U & vlSymsp->TOP__test_top__core_top0.__PVT__exe_mem_mem_addr_o))
                                     ? ((0xffffff00U 
                                         & vlSymsp->TOP__test_top__dpram0.__PVT__data_o) 
                                        | (0xffU & vlSymsp->TOP__test_top__core_top0.__PVT__exe_mem_mem_data_o))
                                     : ((1U == (3U 
                                                & vlSymsp->TOP__test_top__core_top0.__PVT__exe_mem_mem_addr_o))
                                         ? ((0xffff0000U 
                                             & vlSymsp->TOP__test_top__dpram0.__PVT__data_o) 
...
VL_INLINE_OPT void Vtest_top_core_top::_combo__TOP__test_top__core_top0__5(Vtest_top__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->rst_i) {
        ...
        vlSymsp->TOP__test_top__core_top0.__PVT__ctrl_stall_o = 0U;
    } else {
        vlSymsp->TOP__test_top__core_top0.__PVT__mem_reg_waddr_o 
            = vlSymsp->TOP__test_top__core_top0.__PVT__exe_mem_reg_waddr_o;
        vlSymsp->TOP__test_top__core_top0.__PVT__ctrl_stall_o 
            = ((IData)(vlSymsp->TOP__test_top__core_top0.__PVT__exe_pipe_ctrl_stallreq_o)
                ? 0xfU : (((IData)(vlSymsp->TOP__test_top__core_top0.__PVT__id_exe_id_inst_is_load_o) 
