...
VL_MODULE(Vtest_top_test_top) {
  public:
    ...
    IData/*31:0*/ __PVT__regfile0__DOT__i;
    IData/*31:0*/ __PVT__regfile0__DOT__regs[32];
  ...
  public:
    static void _initial__TOP__test_top__4(Vtest_top__Syms* __restrict vlSymsp) VL_ATTR_COLD;
